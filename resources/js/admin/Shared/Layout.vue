  ...
  <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap shadow">
    ...
    <div class="navbar-nav">
      <div class="nav-item text-nowrap">
        <Link
          as="button"
          class="nav-link bg-transparent border-0 px-3"
          href="/logout?is_admin=1"
          method="post"
        >
          Выйти
        </link>
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              <li class="nav-item">
                <Link class="nav-link" :class="{'active': $page.url === '/admin'}" aria-current="page" href="/admin">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                  Главная
                </Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link" :class="{'active': $page.url === '/admin/order'}" aria-current="page" href="/admin">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                  Заказы
                </Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link" :class="{'active': $page.url === '/admin/products'}" aria-current="page" href="/admin">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                  Товары
                </Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link" :class="{'active': $page.url === '/admin/users'}" aria-current="page" href="/admin">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                  Пользователи
                </Link>
              </li>
